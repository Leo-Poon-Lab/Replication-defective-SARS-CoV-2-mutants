...
names(seq_mut_2b_4_full_new) <- gsub("Mutant_2b", "Mutant_2b_v2", names(seq_mut_2b_4_full_new))
writeXStringSet(seq_mut_2b_4_full_new, "../results/Final design for Syntethesis/Mutant_2b_4_seq_v2_202204119.fasta")

source("./helper/compare_seqs_to_table.r")
df_cmp <- compare_seqs(seq_int=seq_mut_2b_4_full_new, seq_ref=seq_mut_2b_4_full)
write_csv(df_cmp, "../results/Final design for Syntethesis/Mutant_2b_4_info_v2_202204119.csv")
